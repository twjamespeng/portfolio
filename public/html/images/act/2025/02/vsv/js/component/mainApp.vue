...
module.exports = {
  ...
  components: {
    'item-app': httpVueLoader((window.location.hostname.includes("github.io") ? "/portfolio" : "") + "/html/images/act/2025/02/vsv/js/component/itemApp.vue"),
    'modal-app': httpVueLoader((window.location.hostname.includes("github.io") ? "/portfolio" : "") + "/html/images/act/2025/02/vsv/js/component/modalApp.vue")
  },
  methods: {
    init: function() {
      var main = this;
      ...
      if (timeFromURL) {
        ...
        if (timeFromURL.substr(0,8) == '20230424') {
          ...
          $("meta[property='og:image']").attr("content", "https://www.vivatv.com.tw/html/images/act/2025/02/vsv/images/og-wave2.jpg");
