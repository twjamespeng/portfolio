      ...
      <div class="row justify-content-center mb-3 mb-xl-5">
        <div class="col-12 d-flex flex-column">
          <div class="d-flex flex-column flex-lg-row px-2">
            <div class="vsv-logo">
              <picture>
                <source srcset="images/act/2025/03/vsv/images/vsv-logo.png" media="(min-width: 992px)">
                <img class="img-fluid pe-none us-none" src="images/act/2025/03/vsv/images/mobile/vsv-logo.png" alt="美好黃金週 logo">
              </picture>
            </div>
            <div class="viva-live">
          ...
          <div class="live-text">
            <picture>
              <source srcset="images/act/2025/03/vsv/images/live-text.png" media="(min-width: 992px)">
              <img class="img-fluid pe-none us-none" src="images/act/2025/03/vsv/images/mobile/live-text.png" alt="">
            </picture>
          </div>
        </div>
      </div>
          ...
          <a v-if="item.launch" :href="item.url" class="d-block">
            <div class="item-today-wrapper d-flex flex-column px-2">
              <div v-if="item.today" class="live-time">
                <picture>
                  <source srcset="images/act/2025/03/vsv/images/live-time-1.png" media="(min-width: 992px)">
                  <img class="img-fluid pe-none us-none" src="images/act/2025/03/vsv/images/mobile/live-time-1.png" alt="今日播出時間">
                </picture>
              </div>
              <div v-else class="live-time">
                <picture>
                  <source srcset="images/act/2025/03/vsv/images/live-time-2.png" media="(min-width: 992px)">
                  <img class="img-fluid pe-none us-none" src="images/act/2025/03/vsv/images/mobile/live-time-2.png" alt="今日播出時間">
                </picture>
              </div>
          ...
          <div class="section-wrapper position-relative">
            ...
            <div class="section-row d-flex flex-column">
              ...
              <div class="section-title w-100 text-center">
                <picture>
                  <source srcset="images/act/2025/03/vsv/images/title.png" media="(min-width: 992px)">
                  <img class="img-fluid pe-none us-none" src="images/act/2025/03/vsv/images/mobile/title.png" alt="title">
                </picture>
              </div>
              <!-- 公格商品 -->
...
module.exports = {
  data: function() {
    return {
      isLoading: false,
      failed: false,
      imgError: 'this.src="/html/images/act/2025/03/vsv/images/img-error.png"',
      items: [],
      wave1: false,
      wave2: false,
      tvoneday: false,
  ...
  methods: {
    initItem: function() {
      var self = this;
      var path1 = (window.location.hostname.includes("github.io") ? "/portfolio" : "") + "/html/images/act/2025/03/vsv/json/data.json";
      var path;
    ...
    generateURL: function() {
      for (let i=0; i < this.items.length; i++) {
        ...
        // this.$set(this.items[i], "imgsrc", '/html/images/act/2025/03/vsv/images/product/'+ this.items[i].id +'/1.jpg');
      }
    },
    ...
    isLoad: function(e) {
      ...
      if (e.target.naturalWidth == 1) {
        ...
        e.target.src = "/html/images/act/2025/03/vsv/images/product/"+ t +".jpg";
    ...
    altImage: function(e) {
      ...
      if (e.target.imgchecked) {
        e.target.src = "/html/images/act/2025/03/vsv/images/img-error.png";
      } else {
        e.target.src = "/html/images/act/2025/03/vsv/images/product/"+ t +".jpg";
      }
