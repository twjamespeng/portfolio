    ...
    <div class="d-flex flex-column position-relative">
      ...
      <div class="landing-main">
        <picture class="d-block position-relative" style="z-index: 2;">
          <source srcset="images/act/2024/05/flyer/images/wave1/landing.jpg" media="(min-width: 992px)">
          <img class="img-fluid pe-none us-none" src="images/act/2024/05/flyer/images/wave1/mobile/landing.jpg" alt="landing">
        </picture>
              ...
              <div class="px-1 px-lg-3">
                <a href="#eventModal-1" data-bs-toggle="modal" class="d-block">
                  <picture class="d-block">
                    <source srcset="images/act/2024/05/flyer/images/wave1/primary-btn-1.png" media="(min-width: 992px)">
                    <img class="img-fluid us-none" src="images/act/2024/05/flyer/images/wave1/mobile/primary-btn-1.png" alt="滿額抽5000金幣">
                  </picture>
                </a>
              </div>
              <div class="px-1 px-lg-3">
                <a href="#eventModal-2" data-bs-toggle="modal" class="d-block">
                  <picture class="d-block">
                    <source srcset="images/act/2024/05/flyer/images/wave1/primary-btn-2.png" media="(min-width: 992px)">
                    <img class="img-fluid us-none" src="images/act/2024/05/flyer/images/wave1/mobile/primary-btn-2.png" alt="滿額送最高600銀幣">
                  </picture>
                </a>
              </div>
              <div class="px-1 px-lg-3">
                <a href="#eventModal-3" data-bs-toggle="modal" class="d-block">
                  <picture class="d-block">
                    <source srcset="images/act/2024/05/flyer/images/wave1/primary-btn-3.png" media="(min-width: 992px)">
                    <img class="img-fluid us-none" src="images/act/2024/05/flyer/images/wave1/mobile/primary-btn-3.png" alt="滿額抽吉米莊">
                  </picture>
                </a>
              </div>
            </div>
      ...
      <!-- 公格商品 itemApp -->
      <div class="container-fluid container-item-app p-0 position-relative">
        <item-app></item-app>  
      </div>
...
module.exports = {
  ...
  components: {
    'item-app': httpVueLoader((window.location.hostname.includes("github.io") ? "/portfolio" : "") + "/html/images/act/2024/05/flyer/js/component/itemApp.vue"),
    'modal-app': httpVueLoader((window.location.hostname.includes("github.io") ? "/portfolio" : "") + "/html/images/act/2024/05/flyer/js/component/modalApp.vue")
  },
  methods: {
    init: function() {
      var main = this;
      ...
      if (timeFromURL) {
        ...
        if (timeFromURL.substr(0,8) == '20230424') {
          ...
          $("meta[property='og:image']").attr("content", "https://www.vivatv.com.tw/html/images/act/2024/05/flyer/images/og-wave2.jpg");
      ...
      // if ( moment(timeNow).isBetween('2023-06-05 00:00:00', '2023-06-25 23:59:59', 'second', '[]') ) {
      //   this.wave2 = true;
