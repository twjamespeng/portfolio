...
module.exports = {
  ...
  components: {
    'item-app': httpVueLoader((window.location.hostname.includes("github.io") ? "/portfolio" : "") + "/html/images/act/2024/08/flyer/js/component/itemApp.vue"),
    'modal-app': httpVueLoader((window.location.hostname.includes("github.io") ? "/portfolio" : "") + "/html/images/act/2024/08/flyer/js/component/modalApp.vue")
  },
  methods: {
    init: function() {
      var main = this;
