<template>
  <div>
    <div class="w-100 overflow-hidden d-flex flex-column position-relative">

      
      <picture>
        <source srcset="images/act/2023/05/flyer/images/wave1/landing.jpg" media="(min-width: 992px)">
        <img class="img-fluid pe-none us-none" src="images/act/2023/05/flyer/images/wave1/mobile/landing.jpg" alt="landing">
      </picture>
...
module.exports = {
  ...
  components: {
    'item-app': httpVueLoader((window.location.hostname.includes("github.io") ? "/portfolio" : "") + "/html/images/act/2023/05/flyer/js/component/itemApp.vue"),
    'modal-app': httpVueLoader((window.location.hostname.includes("github.io") ? "/portfolio" : "") + "/html/images/act/2023/05/flyer/js/component/modalApp.vue")
  },
  methods: {
    init: function() {
      var main = this;
      ...
      if (timeFromURL) {
        ...
        if (timeFromURL.substr(0,8) == '20230424') {
          ...
          $("meta[property='og:image']").attr("content", "https://www.vivatv.com.tw/html/images/act/2023/05/flyer/images/og-wave2.jpg");
